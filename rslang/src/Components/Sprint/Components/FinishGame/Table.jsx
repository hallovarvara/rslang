...
const headCells = [
  {
    id: 'name', numeric: false, disablePadding: true, label: 'Слова',
  },
  {
    id: 'calories', numeric: true, disablePadding: false, label: 'Перевод',
  },
  {
    id: 'fat', numeric: true, disablePadding: false, label: 'Аудио',
  },
  {
    id: 'carbs', numeric: true, disablePadding: false, label: 'Угадал',
  },
];
...
export default function EnhancedTable({ complete, mistake, audioPlay }) {
  /*   const rows = [
